...
C:\Python39\python validator-cli.py transform --directory examples\datasets\4-directories\dir-csv examples\datasets\4-directories\data-mapping.csv

:: Folder dir-gpkg transformation
C:\Python39\python validator-cli.py transform --directory examples\datasets\4-directories\dir-gpkg examples\datasets\4-directories\data-mapping.csv
